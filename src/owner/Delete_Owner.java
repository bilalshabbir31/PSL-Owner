 ...
 */
public class Delete_Owner extends javax.swing.JFrame {
        ...
        if(option.getSelectedItem()=="Option"){
            ...
            try{
                Connection=objConnectivity.getConnection();
                 PreparedStatement preparedStatement =Connection.prepareStatement("DELETE FROM ownerdb WHERE Owner_Id=?");
            ...
            try{
                Connection=objConnectivity.getConnection();
                 PreparedStatement preparedStatement =Connection.prepareStatement("DELETE FROM ownerdb WHERE Name=?");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Delete_Owner.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Delete_Owner().setVisible(true);
            }
        });
    }
